...
VALUES  ('5421GVJ', '54875241R', 'Alfa Romeo', 'Stelvio', 'TURISMO', 'GASOLINA', DATE('2017-02-25'), TIMESTAMP ('2022-06-23 12:47:29')),
        ('2385KLP', '51487524T', 'Ford', 'Transit', 'FURGONETA', 'HIBRIDO', DATE('2019-08-12'), TIMESTAMP('2023-04-15 10:52:02')),
        ('7843FBD', '52638541M', 'Mercedes-Benz', 'Actros', 'CAMION', 'DIESEL', DATE('2016-05-10'), TIMESTAMP('2021-11-30 11:44:56')),
        ('6521RDS', '53698524X', 'Yamaha', 'YZF-R6', 'MOTOCICLETA', 'GASOLINA', DATE('2020-09-02'), TIMESTAMP('2023-01-18 10:43:34')),
        ('8796QWT', '52003258M', 'Volkswagen', 'Golf', 'TURISMO', 'HIBRIDO', DATE('2018-12-07'), TIMESTAMP('2022-08-09 18:31:15')),
        ('3254PLK', '52485100C', 'Renault', 'Kangoo', 'FURGONETA', 'ELECTRICO', DATE('2021-06-15'), TIMESTAMP('2022-12-02 19:48:43')),
        ('4109LKJ', '53669854K', 'MAN', 'TGS', 'CAMION', 'DIESEL', DATE('2015-03-20'), TIMESTAMP('2020-09-25 20:56:21')),
        ('2156JHG', '52201587M', 'Honda', 'CBR600RR', 'MOTOCICLETA', 'GASOLINA', DATE('2009-10-30'), TIMESTAMP('2019-04-07 08:35:26')),
        ('7531MNB', '52255895X', 'Peugeot', 'Partner', 'FURGONETA', 'HIBRIDO', DATE('2012-01-14'), TIMESTAMP('2018-05-31 08:02:42')),
        ('9874YBV', '58966512D', 'Scania', 'R500', 'CAMION', 'DIESEL', DATE('2017-09-05'), TIMESTAMP('2020-01-11 16:17:49')),
        ('3698VBN', '52487956R', 'BMW', 'R1250GS', 'MOTOCICLETA', 'GASOLINA', DATE('2021-02-18'), TIMESTAMP('2022-06-29 12:01:03')),
        ('1452BNV', '51448759J', 'Toyota', 'Prius', 'TURISMO', 'HIBRIDO', DATE('2018-07-23'), TIMESTAMP('2021-11-12 15:10:12')),
        ('6543LKJ', '52148759P', 'Ford', 'Transit Custom', 'FURGONETA', 'ELECTRICO', DATE('2006-04-05'), TIMESTAMP('2015-08-16 09:50:06')),
        ('7896KJP', '58745145V', 'Volvo', 'FH16', 'CAMION', 'DIESEL', DATE('2016-12-10'), TIMESTAMP('2022-04-21 20:17:50')),
        ('2587BVC', '55214857E', 'Kawasaki', 'Ninja 650', 'MOTOCICLETA', 'GASOLINA', DATE('2020-07-08'), TIMESTAMP('2022-11-30 12:47:29')),
        ('9654QWR', '54875241R', 'Audi', 'A3', 'TURISMO', 'ELECTRICO', DATE('2019-03-17'), TIMESTAMP('2021-07-25 16:17:49')),
        ('4578ZXC', '51487524T', 'Citroën', 'Berlingo', 'FURGONETA', 'HIBRIDO', DATE('2021-10-22'), TIMESTAMP('2023-03-14 20:56:21')),
        ('6325RTY', '52638541M', 'Iveco', 'Eurocargo', 'CAMION', 'DIESEL', DATE('2015-07-29'), TIMESTAMP('2022-12-01 08:02:42')),
        ('2156FGH', '53698524X', 'Suzuki', 'GSX-R750', 'MOTOCICLETA', 'GASOLINA', DATE('2020-12-03'), TIMESTAMP('2023-04-09 10:43:34')),
        ('9654JKL', '52003258M', 'Hyundai', 'Kona', 'TURISMO', 'HIBRIDO', DATE('2017-04-11'), TIMESTAMP('2020-09-20 08:02:42')),
        ('3254TYW', '52485100C', 'Mercedes-Benz', 'Sprinter', 'FURGONETA', 'ELECTRICO', DATE('2011-11-28'), TIMESTAMP('2017-04-05 13:35:25')),
        ('7845CVB', '53669854K', 'MAN', 'TGX', 'CAMION', 'DIESEL', DATE('2016-08-19'), TIMESTAMP('2023-02-24 12:14:52')),
        ('4569JHG', '54875241R', 'Harley-Davidson', 'Street Glide', 'MOTOCICLETA', 'GASOLINA', DATE('2019-01-27'), TIMESTAMP('2022-06-02 10:42:49')),
        ('9652MNB', '51487524T', 'Volkswagen', 'Passat', 'TURISMO', 'HIBRIDO', DATE('2017-06-06'), TIMESTAMP('2022-10-14 15:23:56')),
        ('7845VBN', '52638541M', 'Nissan', 'NV200', 'FURGONETA', 'ELECTRICO', DATE('2020-02-15'), TIMESTAMP('2021-06-27 14:45:51'));
